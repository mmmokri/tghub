...
import '../../styles/admin/AdminEditTaskPage.css';

interface AdminEditTaskPageProps {
  onBack: () => void;
  onGoToCabinet: () => void;
  onGoToGrades: () => void;
}

const AdminEditTaskPage: React.FC<AdminEditTaskPageProps> = ({ 
  onBack, 
  onGoToCabinet, 
  onGoToGrades 
}) => {
  ...
  const [taskName, setTaskName] = useState('Программа на JS');
  const [taskDescription, setTaskDescription] = useState('Создайте программу');
  ...
  return (
    <div className="edit-task-container" style={containerStyle}>
      ...
      <main className="edit-task-content">
        <div className="form-group">
          <label style={hintStyle}>Название задачи</label>
          <input 
            type="text" 
            value={taskName}
